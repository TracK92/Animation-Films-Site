...
> Description of the project: An animation films site to enable users to access some of the most highly rated animation films directly sourced from an API.  
...
```bash
$ git clone https://github.com/TracK92/Animation-Films-Site.git
```
